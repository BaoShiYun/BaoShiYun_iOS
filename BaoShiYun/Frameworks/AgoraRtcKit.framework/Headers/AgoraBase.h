...
enum ERROR_CODE_TYPE
{
  ...
  */
    ...
    */
    ...
    /** 1055: recording and playout devie are both bluetooth, check if the mode of
     * playout device is stereo and the mode of recording device is hand-free 
     */
    ERR_ADM_NO_SUPPORT_BLUETOOTH_COMBINATION = 1055,
