...
@class BSYLiveIMResponderTextView;


/////////////////////////////////////////////////////////////////////////////////
//
//                            BSYLiveIMTextViewDelegate
//
/////////////////////////////////////////////////////////////////////////////////
 ...
 */
@protocol BSYLiveIMTextViewDelegate <NSObject>
/**
 *  点击表情按钮，即“笑脸”后的回调委托。
 ...
 *  本回调函数在处理了表情视图与更多视图的浮现后，进一步调用了 KKBIMInputController 中的 didChangeHeight 委托进行 UI 布局的高度调整。
 *
 *  @param textView 委托者，当前与用户交互的 InputBar。
 ...
 *  本回调函数在处理了表情视图与更多视图的浮现后，进一步调用了 KKBIMInputController 中的 didSendMessage 委托进行消息发送的进一步逻辑处理。
 *
 *  @param textView 委托者，当前与用户交互的 InputBar。
...
/**
 * 【模块名称】BSYLiveIMInputBar
 * 【功能说明】BSYLiveIM 输入条，用于检测、获取用户输入的 UI 组件。
 ...
 */
@interface BSYLiveIMInputBar : UIView
 ...
 *  继承自 UITextView
 */
@property (nonatomic, strong) BSYLiveIMResponderTextView *inputTextView;
...
/**
 *  实现 KKBIMTextViewDelegate 协议的委托。
 */
@property (nonatomic, weak) id<BSYLiveIMTextViewDelegate> delegate;
