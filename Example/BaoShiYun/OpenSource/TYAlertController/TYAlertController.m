...
- (void)configureController
{
    ...
    _backgroundColor = [UIColor clearColor];//[UIColor colorWithRed:0 green:0 blue:0 alpha:0.4];
...
- (void)configureAlertView
{
    ...
    switch (_preferredStyle) {
        ...
        case TYAlertControllerStyleAlert:
            ...
            break;
        case TYAlertControllerStyle_SlideTop:
            [self layoutSlideTopStyleView];
            break;
        case TYAlertControllerStyle_SlideLeft:
            [self layoutSlideLeftStyleView];
            break;
        case TYAlertControllerStyle_SlideRight:
            [self layoutSlideRightStyleView];
            break;
        default:
            break;
    }
...
- (void)layoutSlideTopStyleView
{
    ...
    // add edge constraint
    [self.view addConstraintWithView:_alertView topView:self.view leftView:self.view bottomView:nil rightView:self.view edgeInset:UIEdgeInsetsMake(0, _actionSheetStyleEdging, 0, -_actionSheetStyleEdging)];
...
- (void)layoutSlideLeftStyleView
{
    ...
    // add edge constraint
    [self.view addConstraintWithView:_alertView topView:self.view leftView:self.view bottomView:self.view rightView:nil edgeInset:UIEdgeInsetsMake(0, _actionSheetStyleEdging, 0, -_actionSheetStyleEdging)];
...
- (void)layoutSlideRightStyleView
{
    // remove width constaint
    for (NSLayoutConstraint *constraint in _alertView.constraints) {
        if (constraint.firstAttribute == NSLayoutAttributeWidth) {
    ...
    // add edge constraint
    [self.view addConstraintWithView:_alertView topView:self.view leftView:nil bottomView:self.view rightView:self.view edgeInset:UIEdgeInsetsMake(0, _actionSheetStyleEdging, 0, -_actionSheetStyleEdging)];
